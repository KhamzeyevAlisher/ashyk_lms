...
// Данные взяты согласно количеству лекций и практик из плана
...
// Темы адаптированы под предметы из твоего скрина
let homeworkDataHome = [
    {
        subject: "Қазақстан тарихы",
        status: "Басталмаған",
        statusColor: "gray",
        title: "Тәуелсіздік кезеңіндегі Қазақстанның әлеуметтік дамуы",
        dueDate: "28.04.2026"
    },
    {
        subject: "Менеджмент",
        status: "Орындалуда",
        statusColor: "yellow",
        title: "Ұйымдастырушылық құрылымдарды талдау",
        dueDate: "29.04.2026"
    },
    {
        subject: "Экономикалық теория",
        status: "Басталмаған",
        statusColor: "gray",
        title: "Сұраныс пен ұсыныс заңдылықтары (кесте құру)",
        dueDate: "30.04.2026"
    }
];
