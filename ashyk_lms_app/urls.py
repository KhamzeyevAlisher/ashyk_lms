...
urlpatterns = [
    ...
    path('api/teacher/journal/', teacher_api.get_journal_data, name='api_teacher_journal'),
    path('api/teacher/journal/save/', teacher_api.save_journal_grade, name='api_save_journal_grade'),
