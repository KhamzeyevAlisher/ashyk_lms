# 📄 Документация модуля: Student Dashboard (Панель студента - Главная страница)

**Версия:** 1.0  
**Описание:** Модуль реализует главную страницу  студента с функционалом SPA (Single Page Application). Обеспечивает навигацию по вкладкам без перезагрузки страницы, динамическое обновление URL и рендеринг контента (расписание, домашние задания) на основе JavaScript-данных.
